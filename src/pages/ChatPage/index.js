        ...
        <div className={classes.chat_log_msg__sec}>
            <div className="container">
                <div className="container-wrapper">
                    <Row className="pt-4">
                        <Col lg="2" className={`${classes.chat_img_sec}`}>
                            ...
                            <div className={`p-3 ${classes.sample_chat_img}`}>
                                ...
                                <Row className="smallest-padding-box">
                                    <Col lg="4">
                                            <img src={DescriptionImage} alt="Description Image" className={`img-fluid ${classes.chat_descr_img}`}/>
                                    </Col>
                                    <Col lg="4">
                                            <img src={DescriptionImage} alt="Description Image" className={`img-fluid ${classes.chat_descr_img}`}/>
                                    </Col>
                        ...
                        <Col lg="10">
                            <div className={classes.chatlog_text_box}>
                                ...
                                <div className={classes.chatlog_text_box_icon}>
                                    <img src={ListenIcon} alt="Listen Icon" className="img-fluid"/>
                                </div>
                            </div>
                        </Col>
                    </Row>
