...
import PersonaCompletionHistory from '../../../constituents/ILesson/PersonaCompletionHistory/PersonaCompletionHistory'
import PersonaScenioChartResult from '../../../constituents/ILesson/PersonaScenioChartResult/PersonaScenioChartResult'
    ...
    return (
        <div className="cmn-inner-width">
            <div className="persona_scenaio">
                <div className="text">
                    <p className={classes.head_text}>{t('persona.head_text_check_content')}</p>
                </div>
                    ...
                    <div className={classes.scenaio_content_body}>
                        <div className="left_body">
                            ...
                            <div className={classes.left_body_bottom}>
                                ...
                                <span className={classes.left_body_time}>{t('persona.time_required')}: 30 minutes</span>
                            </div>
                        </div>
                        <div className={classes.right_body}>
                            <p className={classes.right_body_context_status}>{t('persona.context')}</p>
                ...
                <div className={classes.persona_scenaio_footer}>
                    <button className={classes.persona_scenaio_footer_btn}>{t('persona.start_the_scenario')}</button>
                </div>
            </div>
        </div>
    )
