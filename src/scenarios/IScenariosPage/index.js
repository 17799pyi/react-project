...
import SidebarAccordian from '../../constituents/IAccordian/SidebarAccordian'
import AddButtonPurple from '../../constituents/IButton/AddButtonPurple'
...
import GeneralPopupMsg from '../../constituents/IPopupBox/GeneralPopupMsg'
import ScenariosNoCard from '../../constituents/ICard/ScenariosNoCard'
import ScenariosGeneralCard from '../../constituents/ICard/ScenariosGeneralCard'
import ScenariosNoteCard from '../../constituents/ICard/ScenariosNoteCard'
import ScenariosSelectCard from '../../constituents/ICard/ScenariosSelectCard'

import SamplePhoto from '../../property/images/scenarios/sample_man1.png'
import SamplePhoto2 from '../../property/images/scenarios/sample_man2.png'
import SamplePhoto3 from '../../property/images/scenarios/sample_man3.png'
import WarningIcon from '../../property/images/scenarios/warning_icon.png'
import DescriptionImage from '../../property/images/chatlog/description_image.png'
import AddImage from '../../property/images/scenarios/add_image.png'
import AddIcon from '../../property/images/scenarios/add_icon.png'
import CloseIcon from '../../property/images/scenarios/close_icon.png'
import UpArrow from '../../property/images/scenarios/up_arrow.png'
import DownArrow from '../../property/images/scenarios/down_arrow.png'
...
function ScenariosPage() {  
    ...
    const dealHide = () => setShow(false);
    const dealShow = () => setShow(true);
                    ...
                    <div className="scenarios-btn-box mb-2">
                        <Row className="align-items-center">
                            ...
                            <Col xl="9" lg="8" md="8" sm="12" className="align-items-center justify-content-end d-xl-flex d-block">
                                ...
                                <div>
                                    <button className="cmn-btn btn save-btn" onClick={dealShow}>保存</button>
                                        ...
                                        >
                                            <Modal.Body className="text-center cmn-modal-msg-row">
                                                ...
                                                <div className="modal-btn-gp">                                                    
                                                    <button onClick={dealHide} className="btn modal-msg-ok mr-2"> 削除 </button>
                                                    <button onClick={dealHide} className="btn modal-msg-cancel"> キャンセル</button>
                                                </div>
                                            </Modal.Body>
                                    </Modal>
                                </div>
